...
$(document).ready(function() {
    ...
    $(".list").css({"list-style-type": "none", "padding":"0 0 0 1em", "border-left":"5px solid green", "border-right":"5px solid green"});
    ...
    // TODO TOGETHER: Create a border around all elements
        $("*").css({"border": "1px dashed black", "font-family": "'Staatliches', cursive"})
